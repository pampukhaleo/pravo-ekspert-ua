...
const faqs = [
  ...
  },
  {
    ...
    answer: "Терміни проведення експертизи залежать від її типу та складності. Зазвичай, будівельно-технічні експертизи проводяться від 5 до 20 робочих днів. Точні терміни ми обговорюємо з кожним клієнтом індивідуально під час оформлення заявки."
  },
  {
