export const expertiseData = {
    ...
    directions: [
      {
        ...
        fullContent: `
          <p>Од��им з важливих етапів проведення будь-яких будівельно-монтажних або ремонтних робіт, який гарантовано забезпечує дотримання технології виконання робіт, є визначення відповідності виконаних робіт будівельному проекту і нормативно-технічними документами (регламентам, СНіПам, ГОСТам).</p>
  ...
  "elektrotekhnichna-ekspertyza": {
    ...
    content: `
      ...
      <p class="mt-4">Електротехнічну експертизу проводить атестований судовий експерт за фахом «Електротехнічна експертиза» Геннадій Пампуха. За необхідності до проведення дослідження залучаються вузькопрофільні фахівці, а також е��сперти з європейських юрисдикцій.</p>
  ...
  "kompleksna-pozhezhna-ta-elektrotekhnichna-ekspertyza": {
    ...
    description: "Комплексна комісійна пожежно-технічна та електротехнічна експертиза встановлює причини та обставини виникнення пожежі та особливості її перебігу. Експертиза проводиться із залученням до роботи експерти з кількох експертних спеціальностей, а також вузькопрофільних фахівців.",
  ...
  "avtotekhnichna-ekspertyza": {
    ...
    faqs: [
      {
        id: 1,
        question: "Як довго триває автотехнічна експертиза?",
        answer: "Термін проведення автотехнічної експертизи залежить від складності справи та доступності матеріалів. Зазвичай експертиза займає від 5 до 15 робочих днів."
      },
      {
        id: 2,
        question: "Які документи потрібні для проведення автотехнічної експертизи?",
        answer: "Для проведення експертизи необхідні: протокол огляду місця ДТП, схема ДТП, пояснення учасників та свідків, технічні паспорти транспортних засобів та інші документи залежно від обставин справи."
      }
    ]
  }
};
