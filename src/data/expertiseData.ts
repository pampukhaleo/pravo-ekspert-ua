...
export const expertiseData = {
  ...
  "ekonomichna-ekspertyza": {
    ...
    content: `
      ...
      <ul class="list-disc pl-6 space-y-2">
        ...
        <li>Облікові реєстри (касові книги, картки скла��ського обліку, реєстри податкових накладних, відомості аналітичного обліку, журнали-ордери, головні книги);</li>
      ...
      },
      {
        ...
        fullContent: `
          ...
          <ul class="list-disc pl-6 space-y-2">
            ...
            <li>аналізують порядок ��арахування та стягнення податків та зборів;</li>
  ...
  "avtotekhnichna-ekspertyza": {
    ...
    content: `
      ...
      <ul class="list-disc pl-6 space-y-2">
        <li>Встановлюють механізм ДТП;</li>
        <li>Визначають швидкість руху транспортного засобу;</li>
        <li>Встановлюють технічний стан автомобіля;</li>
      </ul>`,
    directions: [],
    faqs: []
  }
